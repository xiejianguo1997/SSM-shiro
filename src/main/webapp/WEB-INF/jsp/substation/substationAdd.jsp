...
<body>
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <form class="form-horizontal m-t" id="substationForm" action="${projectPath }/substation/substationAdd.action" method="post">
            <div class="form-group">
                <label class="col-sm-3 control-label">分局名：</label>
                <div class="col-sm-8">
                    <input id="substationName" name="substationName" class="form-control" type="text" required="required">
                </div>
            </div>
               <div class="form-group">
