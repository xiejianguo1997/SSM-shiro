...
<body>
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <form class="form-horizontal m-t" id="permissionForm" action="${projectPath }/permission/permissionEdit.action" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="permiName" name="permiName" class="form-control" type="text" required="required" value="${permission.permiName }">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="sort" name="sort" class="form-control" type="number" required="required" value="${permission.sort }">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">备注：</label>
                <div class="col-sm-8">
                    <textarea rows="" cols="" name="description" class="form-control">${permission.description }</textarea>
                </div>
            </div>
            <div class="form-group">
    		...
    		$(form).ajaxSubmit({
				...
				success:function(data){
					if(data.resultInfo.success){
						...
						parent.$("#permissionListTable").bootstrapTable("refresh",{query:query});
